...
class ATest(models.Model):
    chatroom_username = models.CharField(max_length=100, blank=True, null=True)
    parent_wx_nickname = models.CharField(max_length=100, blank=True, null=True)
    wx_userid = models.CharField(max_length=100, blank=True, null=True)
    wx_nickname = models.CharField(max_length=100, blank=True, null=True)
    uniquecode = models.CharField(db_column='uniqueCode', max_length=100, blank=True,
...
class AnalysisWxWord(models.Model):
...
class AsterProperties(models.Model):
    ...
    propdesc = models.CharField(db_column='propDesc', max_length=500, blank=True,
                                null=True)  # Field name made lowercase.
...
class AsterSearchConditionGroup(models.Model):
    ...
    searchname = models.CharField(db_column='searchName', max_length=100, blank=True,
                                  null=True)  # Field name made lowercase.
...
class SEdbShop(models.Model):
    shopid = models.CharField(db_column='shopId', unique=True, max_length=20, blank=True,
                              null=True)  # Field name made lowercase.
    shopname = models.CharField(db_column='shopName', max_length=200, blank=True,
                                null=True)  # Field name made lowercase.
    platformtype = models.CharField(db_column='platformType', max_length=50, blank=True,
                                    null=True)  # Field name made lowercase.
    platformname = models.CharField(db_column='platformName', max_length=50, blank=True,
                                    null=True)  # Field name made lowercase.
    platformcode = models.CharField(db_column='platformCode', max_length=30, blank=True,
                                    null=True)  # Field name made lowercase.
...
class SGroupInfo(models.Model):
    ...
    user_id = models.CharField(max_length=255)  # Field name made lowercase.
...
class SGroupMsg(models.Model):
    ...
    createtime = models.DateTimeField(auto_now_add=True)
    updatetime = models.DateTimeField(auto_now_add=True)
    chatroom_name = models.CharField(db_column='chatroom_name', max_length=255, blank=True,
                                     null=True)  # Field name made lowercase.
...
class SOrder(models.Model):
    ...
    masterid = models.CharField(db_column='masterId', max_length=100, blank=True,
                                null=True)  # Field name made lowercase.
    idsource = models.CharField(db_column='IDSource', max_length=100, blank=True,
                                null=True)  # Field name made lowercase.
    resultnum = models.CharField(db_column='resultNum', max_length=20, blank=True,
                                 null=True)  # Field name made lowercase.
    ...
    sorting_code = models.CharField(db_column='Sorting_code', max_length=100, blank=True,
                                    null=True)  # Field name made lowercase.
    ...
    origincode = models.CharField(db_column='originCode', max_length=100, blank=True,
                                  null=True)  # Field name made lowercase.
    destcode = models.CharField(db_column='destCode', max_length=100, blank=True,
                                null=True)  # Field name made lowercase.
...
class SOrderItem(models.Model):
    ...
    md5_encryption = models.CharField(db_column='MD5_encryption', max_length=100, blank=True,
                                      null=True)  # Field name made lowercase.
...
class UUser(models.Model):
    userid = models.BigIntegerField(db_column='userId', unique=True, blank=True,
                                    null=True)  # Field name made lowercase.
    ...
    wechatid = models.CharField(db_column='wechatId', unique=True, max_length=100, blank=True,
                                null=True)  # Field name made lowercase.
    zimeihuiuserid = models.CharField(db_column='zimeihuiUserId', unique=True, max_length=50, blank=True,
                                      null=True)  # Field name made lowercase.
    ...
    shendenguid = models.CharField(db_column='shendengUid', max_length=50, blank=True,
                                   null=True)  # Field name made lowercase.
    ...
    firstchatplatform = models.CharField(db_column='firstChatPlatform', max_length=50, blank=True,
                                         null=True)  # Field name made lowercase.
    firstchatwith = models.CharField(db_column='firstChatWith', max_length=50, blank=True,
                                     null=True)  # Field name made lowercase.
    lastchattime = models.DateTimeField(db_column='lastChatTime', blank=True, null=True)  # Field name made lowercase.
    lastchatplatform = models.CharField(db_column='lastChatPlatform', max_length=50, blank=True,
                                        null=True)  # Field name made lowercase.
    lastchatwith = models.CharField(db_column='lastChatWith', max_length=50, blank=True,
                                    null=True)  # Field name made lowercase.
    ...
    firstlogintime = models.DateTimeField(db_column='firstLoginTime', blank=True,
                                          null=True)  # Field name made lowercase.
    firstloginplatform = models.CharField(db_column='firstLoginPlatform', max_length=100, blank=True,
                                          null=True)  # Field name made lowercase.
    ...
    iszimeihuiuser = models.IntegerField(db_column='isZimeihuiUser', blank=True,
                                         null=True)  # Field name made lowercase.
    istaobaochated = models.IntegerField(db_column='isTaobaoChated', blank=True,
                                         null=True)  # Field name made lowercase.
    iswechatchated = models.IntegerField(db_column='isWechatChated', blank=True,
                                         null=True)  # Field name made lowercase.
    iszimeihuichated = models.IntegerField(db_column='isZimeihuiChated', blank=True,
                                           null=True)  # Field name made lowercase.
    ...
    iszimeihuipayed = models.IntegerField(db_column='isZimeihuiPayed', blank=True,
                                          null=True)  # Field name made lowercase.
    taobaopayamount = models.FloatField(db_column='taobaoPayAmount', blank=True,
                                        null=True)  # Field name made lowercase.
    taobaopaycount = models.IntegerField(db_column='taobaoPayCount', blank=True,
                                         null=True)  # Field name made lowercase.
    taobaofirstpayamount = models.FloatField(db_column='taobaoFirstPayAmount', blank=True,
                                             null=True)  # Field name made lowercase.
    taobaofirstpaytime = models.IntegerField(db_column='taobaoFirstPayTime', blank=True,
                                             null=True)  # Field name made lowercase.
    taobaolastpayamount = models.FloatField(db_column='taobaoLastPayAmount', blank=True,
                                            null=True)  # Field name made lowercase.
    taobaolastpaytime = models.DateTimeField(db_column='taobaoLastPayTime', blank=True,
                                             null=True)  # Field name made lowercase.
    wechatchatcout = models.IntegerField(db_column='wechatChatCout', blank=True,
                                         null=True)  # Field name made lowercase.
    wechatchatinfototal = models.IntegerField(db_column='wechatChatInfoTotal', blank=True,
                                              null=True)  # Field name made lowercase.
    wechatno = models.CharField(db_column='wechatNo', max_length=200, blank=True,
                                null=True)  # Field name made lowercase.
    wechatnickname = models.CharField(db_column='wechatNickname', max_length=200, blank=True,
                                      null=True)  # Field name made lowercase.
    wechatbelongto = models.TextField(db_column='wechatBelongTo', blank=True, null=True)  # Field name made lowercase.
    wechatfirstadd = models.CharField(db_column='wechatFirstAdd', max_length=200, blank=True,
                                      null=True)  # Field name made lowercase.
    wechatfirstaddtime = models.DateTimeField(db_column='wechatFirstAddTime', blank=True,
                                              null=True)  # Field name made lowercase.
    wechatfirstchatwith = models.CharField(db_column='wechatFirstChatWith', max_length=200, blank=True,
                                           null=True)  # Field name made lowercase.
    wechatfirstchattime = models.DateTimeField(db_column='wechatFirstChatTime', blank=True,
                                               null=True)  # Field name made lowercase.
    wechatlastchatwith = models.CharField(db_column='wechatLastChatWith', max_length=200, blank=True,
                                          null=True)  # Field name made lowercase.
    wechatlastchattime = models.DateTimeField(db_column='wechatLastChatTime', blank=True,
                                              null=True)  # Field name made lowercase.
    wechatpayamount = models.FloatField(db_column='wechatPayAmount', blank=True,
                                        null=True)  # Field name made lowercase.
    wechatpaycount = models.IntegerField(db_column='wechatPayCount', blank=True,
                                         null=True)  # Field name made lowercase.
    wechatfirstpaytime = models.DateTimeField(db_column='wechatFirstPayTime', blank=True,
                                              null=True)  # Field name made lowercase.
    wecahtfirstpayamount = models.FloatField(db_column='wecahtFirstPayAmount', blank=True,
                                             null=True)  # Field name made lowercase.
    wecahtlastpaytime = models.DateTimeField(db_column='wecahtLastPayTime', blank=True,
                                             null=True)  # Field name made lowercase.
    wechatlastpayamount = models.FloatField(db_column='wechatLastPayAmount', blank=True,
                                            null=True)  # Field name made lowercase.
    wechatlifestatus = models.CharField(db_column='wechatLifeStatus', max_length=100, blank=True,
                                        null=True)  # Field name made lowercase.
    wechatisvipcarduser = models.IntegerField(db_column='wechatIsVIPCardUser', blank=True,
                                              null=True)  # Field name made lowercase.
    wechatviptime = models.DateTimeField(db_column='wechatVIPTime', blank=True, null=True)  # Field name made lowercase.
    wechatvipcardbalance = models.FloatField(db_column='wechatVIPCardBalance', blank=True,
                                             null=True)  # Field name made lowercase.
    wechatvipcardamount = models.FloatField(db_column='wechatVIPCardAmount', blank=True,
                                            null=True)  # Field name made lowercase.
    zimeihuiphone = models.CharField(db_column='zimeihuiPhone', max_length=20, blank=True,
                                     null=True)  # Field name made lowercase.
    zimeihuinickname = models.CharField(db_column='zimeihuiNickname', max_length=200, blank=True,
                                        null=True)  # Field name made lowercase.
    zimeihuifxrole = models.CharField(db_column='zimeihuiFXRole', max_length=50, blank=True,
                                      null=True)  # Field name made lowercase.
    zimeihuiregistertime = models.DateTimeField(db_column='zimeihuiRegisterTime', blank=True,
                                                null=True)  # Field name made lowercase.
    zimeihuifirstpaytime = models.DateTimeField(db_column='zimeihuiFirstPayTime', blank=True,
                                                null=True)  # Field name made lowercase.
    zimeihuifirstpayamount = models.FloatField(db_column='zimeihuiFirstPayAmount', blank=True,
                                               null=True)  # Field name made lowercase.
    zimeihuilastpaytime = models.DateTimeField(db_column='zimeihuiLastPayTime', blank=True,
                                               null=True)  # Field name made lowercase.
    zimeihuipayamount = models.FloatField(db_column='zimeihuiPayAmount', blank=True,
                                          null=True)  # Field name made lowercase.
    zimeihuipaycount = models.IntegerField(db_column='zimeihuiPayCount', blank=True,
                                           null=True)  # Field name made lowercase.
    iswoaregister = models.IntegerField(db_column='isWOARegister', blank=True, null=True)  # Field name made lowercase.
    createtime = models.DateTimeField(db_column='createTime', blank=True, null=True)  # Field name made lowercase.
    createsource = models.CharField(db_column='createSource', max_length=50, blank=True,
                                    null=True)  # Field name made lowercase.
    updatetime = models.DateTimeField(db_column='updateTime', blank=True, null=True)  # Field name made lowercase.
...
class UUserBasicInfoRecord(models.Model):
    ...
    sourceid = models.CharField(db_column='sourceId', max_length=50, blank=True,
                                null=True)  # Field name made lowercase.
    headimgurl = models.CharField(db_column='headImgurl', max_length=255, blank=True,
                                  null=True)  # Field name made lowercase.
    username = models.CharField(db_column='userName', max_length=200, blank=True,
                                null=True)  # Field name made lowercase.
    sex = models.IntegerField(blank=True, null=True)
...
class UUserTag(models.Model):
    ...
    categoryname = models.CharField(db_column='categoryName', max_length=200, blank=True,
                                    null=True)  # Field name made lowercase.
    firstcategoryid = models.IntegerField(db_column='firstCategoryId', blank=True,
                                          null=True)  # Field name made lowercase.
    uidvalue = models.CharField(db_column='uidValue', max_length=50, blank=True,
                                null=True)  # Field name made lowercase.
    ...
    tagdetaillink = models.CharField(db_column='tagDetailLink', max_length=500, blank=True,
                                     null=True)  # Field name made lowercase.
    createtime = models.DateTimeField(db_column='createTime', blank=True, null=True)  # Field name made lowercase.
    updatetime = models.DateTimeField(blank=True, null=True)
...
class WxUserInfos(models.Model):
    ...
    wx_verifyflag = models.PositiveIntegerField(db_column='wx_verifyFlag', blank=True,
                                                null=True)  # Field name made lowercase.
